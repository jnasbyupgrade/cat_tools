...
AS
  SELECT n1.nspname                                   AS fk_schema_name,
    ...
    JOIN pg_catalog.pg_depend d     ON (
                 d.classid = 'pg_constraint'::pg_catalog.regclass  -- -- GENERATED FILE! DO NOT EDIT! See sql/cat_tools.in.sql
             AND d.objid = k1.oid
             AND d.objsubid = 0
             AND d.deptype = 'n'
    ...
    LEFT JOIN pg_depend d2      ON (
                 d2.classid = 'pg_class'::pg_catalog.regclass      -- -- GENERATED FILE! DO NOT EDIT! See sql/cat_tools.in.sql
             AND d2.objid = ci.oid
             AND d2.objsubid = 0
             AND d2.deptype = 'i'
